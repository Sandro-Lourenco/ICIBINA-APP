...
class DownloadTokenRepository:
    def __init__(self):
        self.db = database.db  # Assumption: global Supabase client instance in shared module

    def register_token(self, jti: str, user_id: str, lesson_id: str, expires_at: int) -> bool:
        """
    ...
    def mark_as_used(self, jti: str) -> bool:
        ...
        try:
            ...
            response = self.db.table("download_tokens").select("status").eq("jti", jti).execute()
