...
async def sync_offline_batch(
    ...
    progress_repository: LessonProgressRepository = Depends(get_lesson_progress_repository),
...
async def generate_download_token(
    ...
    lesson = await course_repository.get_published_lesson(request.course_id, request.lesson_id)
    if lesson is None:
        raise HTTPException(
