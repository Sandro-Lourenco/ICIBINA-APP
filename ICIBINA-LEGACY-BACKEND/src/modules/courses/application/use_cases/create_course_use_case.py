...
class CreateCourseUseCase:
    ...
    async def execute(
        ...
        course = Course(
            ...
            trailer_hls_path=(None if trailer_video else course_data.get("trailer_hls_path")),
            trailer_source_type=(trailer_video.provider if trailer_video else "upload"),
            trailer_external_video_id=(trailer_video.video_id if trailer_video else None),
