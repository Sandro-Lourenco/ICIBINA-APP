...
async def delete_my_account(
    ...
    subscription_gateway: SubscriptionGateway = Depends(get_subscription_gateway),
):
    """Cancela renovações, anonimiza dados pessoais e desabilita a conta atual."""
    request_id = await DeleteMyAccountUseCase(
        profile_repository,
