...
class GetLessonTasksUseCase:
    ...
    def __init__(self, assessment_repo: AssessmentRepository, course_repo: CourseRepository):
        self.assessment_repo = assessment_repo
        self.course_repo = course_repo

    async def execute(self, lesson_id: str, course_id: str, user_id: str) -> Dict[str, Any]:
        """
        ...
        submissions = await self.assessment_repo.get_user_submissions_for_tasks(user_id, task_ids)
