...
MAX_HEARTBEAT_AGE_SECONDS = int(os.getenv("VIDEO_WORKER_HEARTBEAT_MAX_AGE_SECONDS", "45"))
...
def is_worker_alive(now: float | None = None) -> bool:
    ...
    return -CLOCK_SKEW_TOLERANCE_SECONDS <= heartbeat_age <= MAX_HEARTBEAT_AGE_SECONDS
