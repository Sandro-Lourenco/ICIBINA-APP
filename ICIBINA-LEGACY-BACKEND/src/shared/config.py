...
class Settings(BaseModel):
    ...
    def validate_environment(self) -> "Settings":
        ...
        if len(self.certificate_secret_key) < 32:
            raise ValueError("CERTIFICATE_SECRET_KEY must contain at least 32 characters")
        ...
        if self.supabase_service_key.startswith("sb_publishable_"):
            raise ValueError("SUPABASE_SERVICE_ROLE_KEY cannot contain a publishable key")
        return self
